...
\begin{itemize}
    ...
    \item \textbf{Modelo GGUF} (opcional) --- versão quantizada ($\sim$4~GB) para execução sem GPU, baixada automaticamente do Hub quando necessário. Requer apenas \texttt{pip install llama-cpp-python}
\end{itemize}
\end{infobox}
