...
03 & \texttt{preparar\_dataset} & Baixa MedQuAD, traduz para PT-BR e formata em Alpaca & \texttt{training\_data.jsonl} \\
\rowcolor{orange!10}
...
\begin{tikzpicture}[
    ...
    \node[colab, below=1.2cm of s03] (colab) {Colab};
    ...
    \node[left=0.3cm of colab, font=\tiny\sffamily, text width=2cm, align=right] {Fine-Tuning\\QLoRA};
