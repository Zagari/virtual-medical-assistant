...
Para usuários com acesso a GPUs locais (RTX 3090, 4090, A100, etc.), o notebook de execução local (\texttt{03\_fine\_tuning\_local.ipynb}) oferece vantagens:
...
Na aplicação, a variável de ambiente \texttt{FINE\_TUNED\_MODEL} controla a origem. O arquivo \texttt{.env.example} do projeto já vem configurado com o repositório do Hub, permitindo que quem clonar o projeto utilize o modelo sem precisar re-treinar.
