...
Toda resposta inclui a lista de fontes consultadas, extraídas automaticamente dos metadados dos protocolos recuperados pelo ChromaDB e dos dados do paciente:

\begin{itemize}
    \item \textbf{Protocolos:} \texttt{[Pathway-Diabetes, Seção: Tratamento]} --- identifica o documento e a seção específica utilizada.
    \item \textbf{Exames:} \texttt{[Exame: HbA1C, Data: 2026-01-15]} --- identifica o tipo de exame e a data de realização.
    \item \textbf{Prontuário:} \texttt{[Prontuário: Maria Santos]} --- indica que dados do prontuário foram utilizados.
\end{itemize}
