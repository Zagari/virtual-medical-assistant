...
\textbf{BÔNUS -- Aplicação temporariamente em Produção para Teste/Experimentação:} A aplicação está disponível online em um servidor com GPU para demonstração em
\begin{center}
\large\url{https://virtual-medical-assistant.genesis-dataculture.com}
\end{center}
\vspace{0.8em}
